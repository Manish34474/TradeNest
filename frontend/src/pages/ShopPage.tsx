                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="flex gap-8">
                        <div className="w-64 flex-shrink-0">
                            ...
                            {/* Category Filter */}
                            <div className="mb-8">
                                <h3 className="font-semibold text-primary mb-4">Filter By Category</h3>
                            ...
                            {/* Price Filter */}
                            <div className="mb-8">
                                <h3 className="font-semibold text-primary mb-4">Filter By Price</h3>
                        ...
                        <div className="flex-1">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    <h1 className="text-2xl font-bold text-primary mb-2">All Products</h1>
                                    <p className="text-sm text-muted-foreground">
                                        Showing 1-{Math.min(itemsPerPage, allProducts.length)} of {allProducts.length} results
                                    </p>
                                </div>
                                    ...
                                    <Card key={product.id} className="group hover:shadow-lg transition-all duration-300 cursor-pointer">
                                        <CardContent className="p-0">
                                            <div className="relative overflow-hidden rounded-t-lg">
                                                ...
                                                {product.isTopRated && (
                                                    <Badge className="absolute top-2 left-2 bg-primary text-white">HOT</Badge>
                                                )}
                                            </div>
                                            <div className="p-4">
